...
class Bank_branch extends CI_Controller
{
    ...
    public function all_bank_branch()
    {
        ...
        $config["base_url"] = base_url() . "bank_branch/all_bank_branch";
        ...
        if ($this->input->is_ajax_request()) {
            $this->load->view('admin/bank_branch/per_page_bank_branch', $data);
        } else {
            $data['bank'] = $this->Main_model->getValue("", 'master_bank', '*', "ID DESC");
            $this->load->view('admin/bank_branch/bank_branch_tpl', $data);
        }
    }
    ...
    {
        $data['bank'] = $this->Main_model->getValue("", 'master_bank', '*', "ID DESC");
        $this->load->view('admin/bank_branch/bank_branch_from', $data);
    }
    ...
    public function create_bank_branch()
    {
        ...
        $result_msg = $this->Main_model->insertData($data, 'master_bank_branch');
        if ($result_msg) {
            echo "Bank Branch Add Successfully";
        }
    }
    ...
    public function load_update_bank_branch_from($id)
    {
        ...
        $this->load->view('admin/bank_branch/update_bank_branch_from', $data);
    }
    ...
    public function update_bank_branch()
    {
        ...
        $result_msg = $this->Main_model->updateData($data, "master_bank_branch", "id='$id'");
        if ($result_msg) {
            echo "Bank Branch Updated Successfully";
        }
    }
