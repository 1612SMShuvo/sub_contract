...
class Sub_menu extends CI_Controller
{
    ...
    public function all_sub_menu()
    {
        ...
        $config = array();
        $config["base_url"] = base_url() . "sub_menu/all_sub_menu";
    ...
    {
        $data['module'] = $this->Main_model->getValue("", 'master_module', '*', "ID DESC");
        $this->load->view('admin/sub_menu/sub_menu_from', $data);
    }
    ...
    public function create_sub_menu()
    {
        ...
        $result_msg = $this->Main_model->insertData($data, 'master_sub_menu');
        if ($result_msg) {
            echo "Sub-Menu Added Successfully";
        }
    }
    ...
    public function load_update_sub_menu_from($id)
    {
        ...
        $this->load->view('admin/sub_menu/update_sub_menu_from', $data);
    }
    ...
    public function update_sub_menu()
    {
        ...
        $result_msg = $this->Main_model->updateData($data, "master_sub_menu", "id='$id'");
        if ($result_msg) {
            echo "Sub-Menu Updated Successfully";
        }
    }
