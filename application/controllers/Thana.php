...
class Thana extends CI_Controller
{
    ...
    public function all_thana()
    {
        ...
        $config = array();
        $config["base_url"] = base_url() . "thana/all_thana";
        ...
        if ($this->input->is_ajax_request()) {
            $this->load->view('admin/thana/per_page_thana', $data);
        } else {
            ...
            $this->load->view('admin/thana/thana_tpl', $data);
        }
    }
    ...
    {
        $data['division'] = $this->Main_model->getValue("", 'master_division', '*', "ID DESC");
        $this->load->view('admin/thana/thana_from', $data);
    }
    ...
    public function create_thana()
    {
        ...
        $result_msg = $this->Main_model->insertData($data, 'master_thana');
        if ($result_msg) {
            echo "Thana Added Successfully";
        }
    }
    ...
    public function load_update_thana_from($id)
    {
        ...
        $this->load->view('admin/thana/update_thana_from', $data);
    }
    ...
    public function update_thana()
    {
        ...
        $result_msg = $this->Main_model->updateData($data, "master_thana", "id='$id'");
        if ($result_msg) {
            echo "Thana Updated Successfully";
        }
    }
