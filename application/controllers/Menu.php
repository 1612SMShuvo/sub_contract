...
class Menu extends CI_Controller
{
    ...
    public function all_menu()
    {
        ...
        $config["base_url"] = base_url() . "menu/all_menu";
        if ($menu_name) {
        ...
        if ($this->input->is_ajax_request()) {
            $this->load->view('admin/menu/per_page_menu', $data);
        } else {
            $data['module'] = $this->Main_model->getValue("", 'master_module', '*', "ID DESC");
            $this->load->view('admin/menu/menu_tpl', $data);
        }
    }
    ...
    {
        $data['module'] = $this->Main_model->getValue("", 'master_module', '*', "ID DESC");
        $this->load->view('admin/menu/menu_from', $data);
    }
    ...
    public function create_menu()
    {
        ...
        $result_msg = $this->Main_model->insertData($data, 'master_menu');
        if ($result_msg) {
            echo "Menu Add Successfully";
        }
    }
    ...
    public function load_update_menu_from($id)
    {
        ...
        $this->load->view('admin/menu/update_menu_from', $data);
    }
    ...
    public function update_menu()
    {
        ...
        $result_msg = $this->Main_model->updateData($data, "master_menu", "id='$id'");
        if ($result_msg) {
            echo "Menu Update Successfully";
        }
    }
