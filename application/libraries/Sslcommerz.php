<?php
	...
	* */
	...
	class Sslcommerz
	{
	    ...
	    {
	        $this->setSSLCommerzMode((' https://sandbox.sslcommerz.com/gwprocess/v3/api.php') ? 1 : 0);
	        $this->store_id = 'enlis60d9938553241';
	        $this->store_pass = 'enlis60d9938553241@ssl';
	        $this->sslc_submit_url =  $this->sslc_mode .  'https://sandbox.sslcommerz.com/gwprocess/v3/api.php';
	        $this->sslc_validation_url = $this->sslc_mode . 'https://sandbox.sslcommerz.com/validator/api/validationserverAPI.php';
	    }
