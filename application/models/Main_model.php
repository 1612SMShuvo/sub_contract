...
class Main_model extends CI_Model
{
    ...
    public function select_all_module($user_id)
    {
        ...
        $this->db->where('master_module.menu_check', 1);
    ...
    public function select_sub_menu_by_menu_id($id, $user_id)
    {
        ...
        $this->db->where('master_sub_menu.show_status', 0);
    ...
    public function check_permission($id, $module_id, $menu_id, $role_id)
    {
        $this->db->select('*');
...
//    =========================
    ...
    public function count_all_job_posts()
    {
        $this->db->select('job_post.*');
        $query_result = $this->db->get('job_post');
        $result = $query_result->result();
    ...
    public function count_all_new_job_posts()
    {
        $this->db->select('job_post.*');
        $this->db->where('status', 1);
        $this->db->order_by('id', "desc");
    ...
    public function count_all_pending_job_posts()
    {
        $this->db->select('job_post.*');
