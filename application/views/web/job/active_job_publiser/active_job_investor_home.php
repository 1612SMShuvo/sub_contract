<main>
    <section class="publisher-area">
        <div class="container">
            ...
            <div class="publisher-menu mb-4">
                <ul>
                    <li><a   href="<?php echo base_url() ?>active_job_publiser/all_active_job_publiser">Bidder</a></li>
                    <li><a class="active" href="<?php echo base_url() ?>active_job_publiser/all_active_job_publiser_investor">Investor</a></li>
                </ul>
            </div>
            <div class="publisherjob-all investor-all">
                <!-- publisherjob-single -->
                <?php
                foreach($active_job_investor as $v_active_job)
                {?>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="publisherjob-title">
                                    ...
                                    <h4><a href="<?php echo base_url() ?>active_job_publiser/details_active_job_publiser_investor/<?php echo $v_active_job->id; ?>"><?php echo $v_active_job->job_title; ?></h4>
                                </div>
                                <div class="publisherjob-list">
                                    <a href="<?php echo base_url() ?>active_job_publiser/details_active_job_publiser_investor/<?php echo $v_active_job->id; ?>">
                                        <ul>
                                            <li>Work Type: <span>
                                                 <?php
                                            ...
                                            <li>Need Invest Amount: <span><?php echo $v_active_job->investment_amount; ?>TK</span></li>
                                        </ul></a>
                                </div>
                            </div>
                            ...
                            <div class="col-md-5">
                                <div class="publisherjobr-list">
                                    <ul class="pb-2">
                                        ...
                                        <li>Approve Budget <span><?php echo $v_active_job->approximate_budget; ?> TK</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
