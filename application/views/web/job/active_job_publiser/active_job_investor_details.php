    ...
    <section class="specification-top">
        <div class="container">
            <div class="row d-flex align-items-center">
                <?php
                foreach ($details_job_investor as $v_my_bid_details) {
                    ?>
                    <div class="col-md-8">
                        <div class="specification-topleft">
                            ...
                            <ul>
                                ...
                                <li>Total Budget: <span><?php echo $v_my_bid_details->approximate_budget; ?> TK</span></li>
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    <div class="milestone pt-4">
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                            <?php foreach ($payment_term_investor as $v_payment_term) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="btn" style="background-color:#004793; color:white; " onclick="payment_request_investor(<?php echo $v_payment_term->id ?>);">Remainder
                                           </a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if ($v_payment_term->status == 5) {
                                            ...
                                            $total_paid +=(int)$v_payment_term->amount;
                                            echo $total_paid;
                                        } else {
                                            echo "";
                                        } ?>
                ...
                <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                    <div class="reqinvite-right pt-4">
                        <?php
                        foreach ($requirement_details_investor_publiser as $v_requirement) {
                            ?>
...
<script>
    function payment_request_investor($id) {
        $.ajax({
            type: "POST",
            url: '<?php echo base_url() ?>active_job_publiser/payment_request_investor/' + $id,
