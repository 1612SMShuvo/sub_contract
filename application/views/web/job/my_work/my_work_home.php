    ...
    <section class="publisher-area">
        <div class="container">
            <div class="publisher-menu mb-4">
                <ul>
                    <li><a class="active" href="<?php echo base_url() ?>my_work/all_my_work/">Active Job</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="publisherjob-title">
                                ...
                                <h4><a href="<?php echo base_url() ?>my_work/my_work_details/<?php echo $v_my_bid->id; ?>"><?php echo $v_my_bid->job_title; ?></h4>
                            </div>
                            <div class="publisherjob-list">
                                <a href="<?php echo base_url() ?>my_work/my_work_details/<?php echo $v_my_bid->id; ?>">
                                    <ul>
                                        <li>Work Type: <span>
                                                 <?php
