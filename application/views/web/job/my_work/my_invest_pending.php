    ...
    <section class="publisher-area">
        <div class="container">
            <div class="publisher-menu mb-4">
                <ul>
                    <li><a href="<?php echo base_url() ?>my_work/all_active_invest_work/">Active Job</a></li>
                    <li><a class="active"   href="<?php echo base_url() ?>my_work/my_invest_pending/">Pending Work</a></li>
...
<!--                                        <li>Work Statas : 50% Complete</li>-->
                                        ...
                                        <li>Approve Budget <span><?php echo $v_my_bid->approximate_budget; ?> TK</span></li>
                                    </ul>
                                </div>
                            </div>
