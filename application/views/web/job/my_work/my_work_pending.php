    ...
    <section class="publisher-area">
        <div class="container">
            <div class="publisher-menu mb-4">
                <ul>
                    <li><a href="<?php echo base_url() ?>my_work/all_my_work/">Active Job</a></li>
                    <li><a class="active" href="<?php echo base_url() ?>my_work/my_work_pending/">Pending Work</a></li>
                    <li><a href="<?php echo base_url() ?>my_work/my_work_all/">All Work</a></li>
                </ul>
            </div>
            <div class="publisherjob-all investor-all">
                <!-- publisherjob-single -->
                <?php
                foreach ($my_bid as $v_my_bid) {
                    ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="publisherjob-title">
                                    ...
                                    <h4>
                                        <a href="<?php echo base_url() ?>my_work/my_work_pending_details/<?php echo $v_my_bid->id; ?>"><?php echo $v_my_bid->job_title; ?>
                                    </h4>
                                </div>
                                <div class="publisherjob-list">
                                    <a href="<?php echo base_url() ?>my_work/my_work_pending_details/<?php echo $v_my_bid->id; ?>">
                                        <ul>
                                            <li>Work Type: <span>
                                                 <?php
                                            ...
                                            <li>Work
                                                Authority:<span><?php echo $v_my_bid->work_authority_name; ?></span>
                                            </li>
                                            <li>Department: <span>
                                                 <?php
                                            ...
                                            <li>Job Sub-Category:
                                                <span><?php echo $v_my_bid->sub_category_name; ?></span></li>
                                            <li>Tender Caller: <span><?php echo $v_my_bid->organization_name; ?></span>
                                            </li>
                                            <li>Published in: <span><?php echo $v_my_bid->publish_date; ?></span></li>
                                            <li>Closing date: <span><?php echo $v_my_bid->submit_date; ?></span></li>
                                            <li>Approximate Budget: <span><?php echo $v_my_bid->approximate_budget; ?>
                                                    TK</span></li>
                                        </ul>
                                    </a>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="publisherjobr-list">
                                    <ul class="pb-2">
                                        ...
                                        <li>Work Finish Date <span><?php echo $v_my_bid->work_completion_date; ?></span>
                                        </li>
                                        <li>Approve Budget <span><?php echo $v_my_bid->quotation_price_for_bidder; ?>
                                                TK</span></li>
                                    </ul>
                                    <br><br>
                                    <div class="row">
