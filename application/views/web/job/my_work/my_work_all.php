        ...
        <div class="container">
            <div class="publisher-menu mb-4">
                <ul>
                    ...
                    <li><a href="<?php echo base_url() ?>my_work/my_work_pending/">Pending Work</a></li>
                    <li><a class="active"  href="<?php echo base_url() ?>my_work/my_work_all/">All Work</a></li>
                </ul>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="publisherjob-title">
                                    ...
                                    <h4><a href="<?php echo base_url() ?>my_work/my_investor_approve/<?php echo $v_my_bid->id; ?>"><?php echo $v_my_bid->job_title; ?></h4>
                                </div>
                                <div class="publisherjob-list">
                                    <a href="<?php echo base_url() ?>my_work/my_investor_approve/<?php echo $v_my_bid->id; ?>">
                                        <ul>
                                            <li>Work Type: <span>
                                                 <?php
                            ...
                            <div class="col-md-6">
                                <div class="publisherjobr-list">
                                    <ul class="pb-2">
                                        ...
                                        <li>Approve Budget <span><?php echo $v_my_bid->quotation_price_for_bidder; ?>TK</span></li>
                                    </ul>
<!--                                    <ul class="pb-3">-->
