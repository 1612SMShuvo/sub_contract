        ...
        <div class="container">
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    <?php
                    foreach ($investor_pending_job as $v_jobs) { ?>
                        ...
                        <div class="imbidder-single">
                            ...
                            <div class="milestone pt-4">
                                ...
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    <?php
                                    foreach ($payment_term_investor as $v_payment_term) { ?>
                                ...
                                <a href="#" class="btn btn-success" onclick="job_active_investor(<?php echo $post_id; ?>)">Approval</a>
                                <a href="#" class="btn btn-danger" onclick="job_inactive_investor(<?php echo $post_id; ?>)">Decline</a>
                            </div>
                        ...
                        <div class="imbidder-single">
                            <div class="milestone pt-4">
                                <div class="container">
                                    <div class="row">
                                        <?php
                                        foreach ($proposal_details_investor as $v_proposal_details) {
                                            ?>
                                            <div class="col-md-4">
                                                <div class="reqinvite-left">
                                                    ...
                                                    <div class="reqinvite-leftsingle pt-3">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>Similar Work <span>0 Project</span></li>
                                                            <li>General Work <span>0 Project</span></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="reqinvite-righttop">
                                                            ...
                                                            <div class="reqinvite-righttop-right">
                                                                ...
                                                                <p>Quotation Price <span
                                                                        class="ml-20"><?php echo $v_proposal_details->interested_investment; ?></span>
                                                                </p>
                                                            </div>
                                                        </div>
...
<script>
    function job_active_investor($id) {
        $.ajax({
            type: "POST",
            url: '<?php echo base_url() ?>my_work/investor_active_job/' + $id,
            success: function (result) {
                if (result) {
                    window.setTimeout(function () {
                        window.location.href = "<?php echo base_url()?>my_work/my_investor_approve/<?php echo $post_id;?>";
                    }, 2000);
                    return false;
                } else {
                    return false;
...
<script>
    function job_inactive_investor($id) {
        $.ajax({
            type: "POST",
            url: '<?php echo base_url() ?>my_work/investor_inactive_job/' + $id,
            success: function (result) {
                if (result) {
                    window.setTimeout(function () {
                        window.location.href = "<?php echo base_url()?>my_work/my_investor_approve/<?php echo $post_id;?>";
