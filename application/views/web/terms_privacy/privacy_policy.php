...
<section class="newjobs-area">
    <div class="container">
        ...
        <center><h2>Interpretation and Definitions</h2></center>
        <hr>
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Tendering, House-296,Road 1, Adabor, Dhaka 1207.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to Enlist Work, accessible from <a href="http://enlistwork.com/" rel="external nofollow noopener" target="_blank">http://enlistwork.com/</a></p>
            </li>
        
        </ul>
        <br><br>
        <center><h2>Collecting and Using Your Personal Data</h2></center>
        <hr>
        ...
        <br><br>
        <center><h2>Children's Privacy</h2></center>
        <hr>
        ...
        <br>
        <hr>
        <center><h2>Links to Other Websites</h2></center>
