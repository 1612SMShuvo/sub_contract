        ...
        <div class="container">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">List of Investors</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">List of Bidders </button>
                </li>
                <li class="nav-item" role="presentation">
                ...
                <div class="tab-pane fade active" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                    <div class="milestone pt-4">
                        <table class="table table-striped">
                            ...
                            <?php
                            $i = 0;
                            foreach ($all_bidder as $bidder_data) {
                                $i++; ?>
                                <tr>
                                    <td><?php echo $i; ?></td>
                                    <td><?php echo $bidder_data->job_title; ?></td>
                                    <td><?php echo $bidder_data->approximate_budget; ?></td>
                                    <td><?php echo $bidder_data->user_name; ?></td>
                                    <td><?php echo $bidder_data->organization_name; ?></td>
                                    <td><?php echo $bidder_data->quotation_price_for_bidder; ?></td>
                                </tr>
                            <?php } ?>
                            </tbody>
                        </table>
