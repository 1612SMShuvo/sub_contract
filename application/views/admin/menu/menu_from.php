<form action="" method="POST" id="add_menu_frm" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <input id="menu_name1" onblur="check_duplicate()" name="menu_name" type="text" class="form-control" placeholder="Menu Name....">
        <span id="m2"></span>
    </div><br>
    <div class="form-group">
    ...
    $(document).ready(function () {
        $('#add_menu_frm').submit(function () {
            if (validation() == true) {
                ...
                $.ajax({
                    type: "POST",
                    url: '<?php echo base_url() ?>menu/create_menu',
                    data: dataString,
...
<script>
    function check_duplicate() {
        ...
        $.ajax({
            type:'POST',
            url:'<?php echo base_url()?>menu/check_duplicate_data',
