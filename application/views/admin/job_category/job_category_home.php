                    ...
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <button type="button" class="btn btn-success" data-backdrop="static"
                                            data-keyboard="false" data-bs-toggle="modal" data-bs-target="#load_modal" onclick="return add_category();">
                                        Add Category
                                    </button>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="title">
                                    <h3 class="title-text">All Job Category</h3>
                                    <div class="widget-content">
                                        <div class="table-responsive">
                                            <table class="table f-border-none table-hover">
                                                ...
                                                <?php
                                                $i = 0;
                                                foreach ($job_category as $v_category) {
                                                $i++; ?>
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            if ($v_category->status == 1) { ?>
                                                                ...
                                                                <a href="#"
                                                                   onclick="role_inactive(<?php echo $v_category->id; ?>)"
                                                                   class="btn btn-warning" title="Inactive">
                                                                    <i class="fa fa-arrow-down"></i>
                                                                </a>
                                                            <?php } else { ?>
                                                                <a href="#"
                                                                   onclick="role_active(<?php echo $v_category->id; ?>)"
                                                            ...
                                                            <?php } ?>
                                                            <a href="#"
                                                               onclick="delete_user(<?php echo $v_category->id; ?>)"
...
<div class="modal fade" id="load_modal" tabindex="-1" aria-labelledby="exampleStandardModalLabel" style="display: none;" aria-hidden="true">
    ...
    <script>
        function add_category() {
            $.ajax({
                type: "POST",
                url: '<?php echo base_url() ?>job_category/load_add_category_from',
    ...
    <script>
        function role_active($id) {
            $.ajax({
                type: "POST",
                url: '<?php echo base_url() ?>job_category/category_active/' + $id,
                success: function (result) {
                    if (result) {
    ...
    <script>
        function role_inactive($id) {
            $.ajax({
                type: "POST",
                url: '<?php echo base_url() ?>job_category/category_inactive/' + $id,
                success: function (result) {
                    if (result) {
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        $.ajax({
                            type: "POST",
                            url: '<?php echo base_url() ?>job_category/delete_category/' + $id,
                            success: function (result) {
                                if (result) {
                                    return false;
                                } else {
