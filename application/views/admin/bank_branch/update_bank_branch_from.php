<?php foreach ($bank_branch as $v_data) { ?>
    <form action="" method="POST" id="add_bank_branch_frm" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input id="bank_branch_name" name="bank_branch_name" value="<?php echo $v_data->bank_branch_name; ?>" type="text"
                   class="form-control"
                   placeholder="bank_branch Name....">
            <span id="m2"></span>
        </div><br>
        <div class="form-group">
            <input type="submit" class="form-control btn btn-success" value="Update bank branch">
        </div><br><br>
    ...
    $(document).ready(function () {
        $('#add_bank_branch_frm').submit(function () {
            if (validation() == true) {
                ...
                $.ajax({
                    type: "POST",
                    url: '<?php echo base_url() ?>bank_branch/update_bank_branch',
                    data: dataString,
