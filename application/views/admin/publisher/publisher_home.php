...
<script>
    function publisher_active($id) {
        $.ajax({
            type: "POST",
            url: '<?php echo base_url() ?>publisher/publisher_active/' + $id,
            success: function (result) {
                if (result) {
                    window.location.href = "<?php echo base_url()?>publisher/all_publisher";
                    return false;
                } else {
                    return false;
                }
...
<script>
    function publisher_inactive($id) {
        $.ajax({
            type: "POST",
            url: '<?php echo base_url() ?>publisher/publisher_inactive/' + $id,
            success: function (result) {
                if (result) {
