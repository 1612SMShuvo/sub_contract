                    ...
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <button type="button" class="btn btn-success" data-backdrop="static"
                                            data-keyboard="false" data-bs-toggle="modal" data-bs-target="#load_modal" onclick="return add_sub_category();">
                                        Add Sub Category
                                    </button>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="title">
                                    <h3 class="title-text">All Job Sub Category</h3>
                                    <div class="widget-content">
                                        <div class="table-responsive">
                                            <table class="table f-border-none table-hover">
                                                ...
                                                <?php
                                                $i = 0;
                                                foreach ($sub_categorys as $v_sub_category) {
                                                    $i++; ?>
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            if ($v_sub_category->status == 1) { ?>
                                                                ...
                                                                <a href="#"
                                                                   onclick="sub_category_inactive(<?php echo $v_sub_category->id; ?>)"
                                                                   class="btn btn-warning" title="Inactive">
                                                                    <i class="fa fa-arrow-down"></i>
                                                                </a>
                                                            <?php } else { ?>
                                                                <a href="#"
                                                                   onclick="sub_category_active(<?php echo $v_sub_category->id; ?>)"
                                                            ...
                                                            <?php } ?>
                                                            <a href="#"
                                                               onclick="delete_sub_category(<?php echo $v_sub_category->id; ?>)"
...
<div class="modal fade" id="load_modal" tabindex="-1" aria-labelledby="exampleStandardModalLabel" style="display: none;" aria-hidden="true">
    ...
    <script>
        function add_sub_category() {
            $.ajax({
                type: "POST",
                url: '<?php echo base_url() ?>job_sub_category/load_add_sub_category_from',
    ...
    <script>
        function sub_category_active($id) {
            $.ajax({
                type: "POST",
                url: '<?php echo base_url() ?>job_sub_category/sub_category_active/' + $id,
                success: function (result) {
                    if (result) {
    ...
    <script>
        function sub_category_inactive($id) {
            $.ajax({
                type: "POST",
                url: '<?php echo base_url() ?>job_sub_category/sub_category_inactive/' + $id,
                success: function (result) {
                    if (result) {
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        $.ajax({
                            type: "POST",
                            url: '<?php echo base_url() ?>job_sub_category/delete_sub_category/' + $id,
                            success: function (result) {
                                if (result) {
                                    return false;
                                } else {
